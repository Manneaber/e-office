    ...
    <div class="container">
        ...
        <form action="<?php echo base_url('Insertdata/editdata'); ?>" method="post">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="devicesub_name" name="devicesub_name" placeholder="Name of equipments" value="<?php echo $query->devicesub_name; ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-group">
                        <select class="form-control" id="devicesub_type" name="devicesub_type">
                            <option><?php echo $query->type_name; ?></option>
                        </select>
                    </div>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="devicesub_rentable" name="devicesub_rentable" value="<?php echo $query->devicesub_rentable; ?>">
